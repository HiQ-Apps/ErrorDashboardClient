...
>(({ className, ...props }, ref) => (
  <MenubarPrimitive.Root
    ref={ref}
    className={cn(
      "flex h-9 items-center space-x-1 rounded-md border border-slate-200 bg-white p-1 shadow-sm dark:border-slate-800 dark:bg-slate-900",
      className
    )}
    {...props}
  />
...
const MenubarShortcut = ({
  ...
  return (
    <span
      className={cn(
        "ml-auto text-md tracking-widest text-slate-500 dark:text-slate-400",
        className
      )}
      {...props}
    />
