        ...
        <Card className="w-3/4 mb-20 text-sm flex flex-col justify-center p-10">
          ...
          <CardContent>
            ...
            <p className="mb-6">
              ...
              Terms, our Privacy Policy, and any other policies referenced
              herein. If you do not agree to these Terms, you may not use the
              Service.
            </p>
            ...
            <p className="mb-6">
              ...
              troubleshooting. By using the Service, you agree to provide
            ...
            <p className="mb-6">
              ...
              and sublicensable right to use, reproduce, modify, adapt, publish,
              translate, create derivative works from, distribute, and display
              such User Data in any media. This license allows us to use your
              data for any purpose, including improving and marketing our
              Service.
            </p>
            ...
            <p className="mb-6">
              ...
              or inability to use the Service; (ii) any unauthorized access to
              ...
              third party; or (v) any errors or omissions in any content or for
